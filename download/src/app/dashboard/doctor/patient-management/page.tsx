...
export default function DoctorPatientManagementPage() {
  ...
  const T = currentTranslations.doctorPatientManagement;
      ...
      <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="font-headline text-3xl text-primary flex items-center">
            <Users className="mr-2 h-8 w-8" /> {T?.pageTitle || 'Patient Management'}
          </CardTitle>
          <CardDescription>{T?.pageDescription || 'View and manage patient records.'}</CardDescription>
        </CardHeader>
        <CardContent>
          {patients.length > 0 ? (
            <Table>
